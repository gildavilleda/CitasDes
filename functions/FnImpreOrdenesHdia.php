...
/*Autor: Jasson Rodriguez
  Fecha: 11-09-2020*/
class FnImpreOrdenesHdia
{
    protected $infoCita;

    function InfoOrdenesHdia($data)
    {
        //print_r($data);
        $this->infoCita = $data;
    }

    function RenderOrdenesHdia()
    {
        ...
        <head>
            ...
            <link rel=File-List href="am8l6-y5ftz_files/filelist.xml">
            <link rel=Edit-Time-Data href="am8l6-y5ftz_files/editdata.mso">
            <link rel=OLE-Object-Data href="am8l6-y5ftz_files/oledata.mso">
            <!--[if gte mso 9]><xml>
                <o:DocumentProperties>
                    <o:Author>Marisol Camey</o:Author>
                    <o:Created>2020-09-08T12:37:36Z</o:Created>
                    <o:LastSaved>2020-09-21T12:26:52Z</o:LastSaved>
                </o:DocumentProperties>
            </xml><![endif]-->
            <style>
                <!--table
 ...
 collapse;table-layout:fixed;width:725pt' id="tblImpresion">
            ...
            <tr height=31 style='mso-height-source:userset;height:23.25pt' id='r0'>
                <td colspan=10 rowspan="2" height=31 class=x40 width=967 style='height:23.25pt;' align=left valign=top><span style='mso-ignore:vglayout;position:absolute;z-index:0;margin-left:68px;margin-top:0px;width:79px;height:80px'><img width=105 height=105 src="../img/logo.png"></span><span  style='mso-ignore:vglayout2'><table cellpadding=0 cellspacing=0><tr><td colspan=10 height=31 class=x36 width=967 style='height:23.25pt;'>Hospital Nacional Especializado <br> de Villa Nueva</td></tr></table></span></td>
            </tr>

           <!--  <tr height=31 style='mso-height-source:userset;height:23.25pt' id='r1'>
                <td colspan=10 height=31 class=x36 style='height:23.25pt;'>de Villa Nueva</td>
            </tr>-->
            <tr height=31 style='mso-height-source:userset;height:23.25pt' id='r2'>
                <td colspan=9 height=31 class=x36 style='height:23.25pt;'></td>
                <td></td>
            </tr>
            ...
            <tr height=20 style='mso-height-source:userset;height:15pt' id='r4'>
                <td colspan=10 height=20 class=x37 style='height:15pt;'>HOJA DE ENFERMERÍA</td>
            </tr>
            ...
            <tr height=20 style='mso-height-source:userset;height:15pt' id='r7'>
                ...
                <td colspan=5 class=x34 style='border-bottom:1px solid windowtext;'><?php echo $matriz2['Nombre'];?></td>
                <td colspan=2 class=x39>No. Expediente:</td>
                <td colspan=2 class=x34 style='border-bottom:1px solid windowtext;'><?php echo $matriz2['CitStrRegMedico'];?></td>
            </tr>
            <tr height=20 style='mso-height-source:userset;height:15pt' id='r8'>
                <td height=20 class=x22 style='height:15pt;'></td>
                <td colspan=2 class=x33></td>
                <td colspan=2 class=x33></td>
                <td class=x22></td>
                <td class=x22></td>
            ...
            <tr height=20 style='mso-height-source:userset;height:15pt' id='r9'>
                ...
                <td colspan=4 class=x34 style='border-bottom:1px solid windowtext;'><?php echo $matriz2['EdadPaciente'];?></td>
                <td class=x23></td>
                <td class=x24></td>
            ...
            <tr height=21 style='mso-height-source:userset;height:15.75pt' id='r12'>
                <td colspan=1 height=17 class=x29 style='border-right:1px solid windowtext;border-bottom:2px solid windowtext;height:12.75pt;'>FECHA Y HORA</td>
                <td colspan=7 class=x30 style='border-right:2px solid windowtext;border-bottom:2px solid windowtext;'>TRATAMIENTO Y OBSERVACIONES</td>
                <td class=x27 colspan="2">FIRMA</td>
            </tr>

            <?php foreach ($matriz2['ArrayOrdenes'] as $row) { ?>
            <tr height=86 style='mso-height-source:userset;height:90pt' id='r13'>
                <td colspan=1 height=83 class=x32 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;height:62.25pt;'><?php echo $row['datFechaHora'] ?></td>
                <td colspan=7 class=x32 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'><?php echo $row['strOrdenesHdia'] ?></td>
