...
<div id="Cita" class="card">
    <div class="modal-header text-center text-white blue-gradient">
        <h3 class="modal-title w-100 font-weight-bold">AGENDA HOSPITAL DE DÍA - ANESTESIA</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="input-group input-group-sm mb-sm-3 col-sm-6">
                                    ...
                                    <select class="form-control" id="inputAyudante1" style="width: 300px" disabled></select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-group input-group-sm mb-sm-auto col-sm-6">
...
<script src="./js/js_AgendaAnestesiaHdia.js" type="text/javascript" defer></script>
