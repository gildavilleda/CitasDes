...
<div id="HitorialCita" class="card">
    <div class="modal-header text-center text-white blue-gradient">
        <h3 class="modal-title w-100 font-weight-bold">REPORTE TRABAJO SOCIAL</h3>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive text-center">
            <table id="tblRepSocial" border="1" class="table table-sm table-hover table-striped table-bordered"
                   cellspacing="0"
                   width="100%" >
                ...
                <th>Status Actual de Paciente</th>
                <th>Observaciones</th>
                </thead>
                <tbody id="tbodyRepSocial">
                </tbody>
            </table>
        </div>
...
<script src="./js/js_RepTrabSocial.js" type="text/javascript" defer></script>
