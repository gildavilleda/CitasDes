...
<div id="Cita" class="card">
    <div class="modal-header text-center text-white blue-gradient">
        <h3 class="modal-title w-100 font-weight-bold">AGENDA HOSPITAL DE DÍA</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col col-sm-3">
                        <button type="button" class="btn btn-success btn-block" id="btnGuardarC" onclick="guardarCirujano()" style="margin-left: 850px">Guardar</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th width="200">Evolución </th>
                        <th width="200">Ordenes médicas</th>
                        <th width="200">Receta</th>
                        <th width="200">Ficha</th>
                    </tr>
                    </thead>
                    <tbody>
                        <td class="text-center"><h1><i class="fas fa-exchange-alt" type="button" id="btnEvol" style="color: #424C54"</i></h1></td>
                        <td class="text-center"><h1><i class="fas fa-notes-medical" type="button" id="btnOrdenesMed" style="color: #424C54"</i></h1></td>
                        <td class="text-center"><h1><i class="fas fa-pills" type="button" id="btnAReceta"style="color: #424C54"</i></h1></td>
                        <td class="text-center"><h1><i class="fas fa-print" type="button" id="btnImprimir"style="color: #424C54"</i></h1></button></td>
                        </tbody>
                </table>
...
<!-- Modal Receta HDia-->
<div class="modal" id="recetaHdia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-center text-white blue-gradient">
                <h4 class="modal-title w-100 font-weight-bold">RECETA</h4>
                <button id="btnCerrarReceta" type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-white">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formDatosCita">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" id="datFechaReceta">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" aria-label="With textarea"  id="textReceta"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
                <div>
                    <input type="hidden" id="inputProgQuiRec" value="">
                </div>
            </div>

            <div class="modal-footer">
                <button class="btn btn-primary float-left"  id="btnImpReceta">IMPRIMIR
                </button>
                <button class="btn btn-success float-left" id="btnGuardarReceta">GUARDAR
                </button>
            </div>
        </div>
    </div>
...
<!-- Modal Evolucion HDia-->
<div class="modal" id="evolucionHdia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-center text-white blue-gradient">
                <h4 class="modal-title w-100 font-weight-bold">EVOLUCION</h4>
                <button id="btnCerrarEvolucion" type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-white">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formDatosCita">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Evolucion</span>
                        </div>
                        <textarea class="form-control" aria-label="With textarea"  id="textEvolucion"></textarea>
                    </div>
                </form>

                <table class="table table-hover" id="tblEvolucion">
                    ...
                    <tbody id="tbodyEvolucion">

                    </tbody>
                </table>

                <div>
                    <input type="text" id="inputProgQuiEvol" value="" hidden>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary float-left"  id="btnImpEvolucion">IMPRIMIR
                </button>
                <button class="btn btn-success float-left" id="btnGuardarEvolucion">GUARDAR
                </button>
            </div>
        </div>
    </div>
...
<script src="./js/js_AgendaQuirurgica.js" type="text/javascript" defer></script>
