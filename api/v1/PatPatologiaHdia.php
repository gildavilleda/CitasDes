...
//Procedimiento para agregar
        try {
            ...
            $stmt = $Db->Sentencia("EXEC patologia.Sp_AgPatologia  ?, ?");

            $stmt->bindParam(1, $_REQUEST{'PatStrMuestra'});
            $stmt->bindParam(2, $_REQUEST{'HdiaNumProgQuirg'});
...
//Procedimiento para Mostrar
        ...
        $data = $Db->GetData("SELECT * FROM patologia.PatologiaHdia ", $_SESSION['dbUser'], $_SESSION['dbPass']);
