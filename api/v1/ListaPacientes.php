...
//Procedimiento para Mostrar
        ...
        $data = $Db->GetData("SELECT CitStrRegMedico as id, CitStrRegMedico + ' ' + CitStrNombCompleto as text FROM cita.vw_Pacientes " . $Wh->strWhere(), $_SESSION['dbUser'], $_SESSION['dbPass']);
