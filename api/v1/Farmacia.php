...
//Procedimiento para Mostrar
        ...
        if(isset($_REQUEST['Medicamento'])){
            ...
            $data = $Db->GetData("SELECT * FROM Farm.vw_mostrarMedReceta WHERE AlmacNumCodPresentInsu = $Medicamento", $_SESSION['dbUser'], $_SESSION['dbPass']);
            echo $ObjectJson->Json('1', 'Ejecucion de Consulta', $data);
        }else{

            $data = $Db->GetData("SELECT * FROM Farm.vw_mostrarMedReceta", $_SESSION['dbUser'], $_SESSION['dbPass']);
            echo $ObjectJson->Json('1', 'Ejecucion de Consulta', $data);
        }
