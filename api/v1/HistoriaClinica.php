...
//Procedimiento para agregar o modificar
        try {
            ...
            $stmt = $Db->Sentencia("EXEC cita.sp_agoModHistoriaClinica ?, ?, ?, ?");

            $stmt->bindParam(1, $_REQUEST{'CitNumHistClinica'});
            $stmt->bindParam(2, $_REQUEST{'CitStrRegMedico'});
...
//Procedimiento para Mostrar
        ...
        $data = $Db->GetData("SELECT * FROM cita.HistoriaClinica", $_SESSION['dbUser'], $_SESSION['dbPass']);
