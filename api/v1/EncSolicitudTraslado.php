...
//Procedimiento para agregar
        ...
        try {
            ...
            $stmt = $Db->Sentencia("EXEC Encam.sp_AddSolicitudTraslado ?, ?, ?, ?, ?, ?");

            $stmt->bindParam(1, $_REQUEST{'EncDatetime'});
            $stmt->bindParam(2, $_REQUEST{'EncEstadoTras'});
            $stmt->bindParam(3, $_REQUEST{'EncTipoTras'});
            $stmt->bindParam(4, $_REQUEST{'EncNumIdServEncam'});
            $stmt->bindParam(5, $_REQUEST{'CitStrRegMedico'});
            $stmt->bindParam(6, $_REQUEST{'CitNumIngresoEmer'});
